  ...
  return (
    ...
    >
      ...
      >
        <svg
          viewBox="0 0 180 180"
          className={`h-24 w-24 drop-shadow-[0_20px_30px_rgba(0,0,0,0.35)] transition-transform duration-300 ${isDragging ? "scale-105" : "animate-[codex-pet-float_3.8s_ease-in-out_infinite]"}`}
        >
          <defs>
          ...
          <ellipse cx="90" cy="77" rx="31" ry="25" fill="url(#codex-glow)" />
          ...
          <path d="M 63 89 C 68 79, 77 79, 82 89" fill="none" stroke="#37CAFF" strokeWidth="6" strokeLinecap="round" filter="url(#codex-face-glow)" />
          <path d="M 98 89 C 103 79, 112 79, 117 89" fill="none" stroke="#37CAFF" strokeWidth="6" strokeLinecap="round" filter="url(#codex-face-glow)" />
          <path d="M 84 103 C 87 108, 93 108, 96 103" fill="none" stroke="#37CAFF" strokeWidth="5.4" strokeLinecap="round" filter="url(#codex-face-glow)" />
